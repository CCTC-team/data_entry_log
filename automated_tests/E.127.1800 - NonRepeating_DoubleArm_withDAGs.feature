Feature: E.127.1800 - NonRepeating_DoubleArm_withDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.127.1800" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/ProjectTypes/NonRepeating_DoubleArm_withDAGs.xml", and clicking the "Create Project" button
